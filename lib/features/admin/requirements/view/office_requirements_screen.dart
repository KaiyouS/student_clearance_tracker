      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Define which programs each office applies to when generating student clearance.',
              style: TextStyle(
                color: Theme.of(
                  context,
      ...
      child: Column(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Every graduating student must clear this office regardless of program.',
                        style: TextStyle(
                          fontSize: 12,
                          color: Theme.of(
                            context,
          ...
          if (!vm.appliesToAll) ...[
            ...
            const SizedBox(height: 4),
            Text(
              'Only students enrolled in the selected programs will have this office on their clearance.',
              style: TextStyle(
                fontSize: 12,
                color: Theme.of(
                  context,
                          ...
                          child: ClipRRect(
                            ...
                            child: Column(
                              children: programs.asMap().entries.map((e) {
                                ...
                                final checked = vm.assignedProgramIds.contains(
                                  program.id,
                                );
